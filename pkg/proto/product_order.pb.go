...
type ProductOrderInfo struct {
	...
	// 销售单号
	SalesOrderNo string `protobuf:"bytes,5,opt,name=salesOrderNo,proto3" json:"salesOrderNo,omitempty"`
	// 销售项号
	...
	// 下单时间
	OrderTime string `protobuf:"bytes,9,opt,name=orderTime,proto3" json:"orderTime,omitempty"`
	// 下单数量
	OrderQTY int32 `protobuf:"varint,10,opt,name=orderQTY,proto3" json:"orderQTY,omitempty"`
	// 成品仓库
	Warehouse string `protobuf:"bytes,11,opt,name=warehouse,proto3" json:"warehouse,omitempty"`
	// 成品入库单
	ReceiptNoteNo string `protobuf:"bytes,12,opt,name=receiptNoteNo,proto3" json:"receiptNoteNo,omitempty"`
	// 生产班组
	ProductionTeam string `protobuf:"bytes,13,opt,name=productionTeam,proto3" json:"productionTeam,omitempty"`
	// 生产优先级
	PriorityLevel int32 `protobuf:"varint,14,opt,name=priorityLevel,proto3" json:"priorityLevel,omitempty"`
	// 交货期限
	DeliveryDate string `protobuf:"bytes,15,opt,name=deliveryDate,proto3" json:"deliveryDate,omitempty"`
	// 创建时间
	CreateTime string `protobuf:"bytes,16,opt,name=createTime,proto3" json:"createTime,omitempty"`
	// 创建人员ID
	CreateUserID   string `protobuf:"bytes,17,opt,name=createUserID,proto3" json:"createUserID,omitempty"`
	CreateUserName string `protobuf:"bytes,47,opt,name=createUserName,proto3" json:"createUserName,omitempty"`
	// 发放时间
	ReleaseTime string `protobuf:"bytes,18,opt,name=releaseTime,proto3" json:"releaseTime,omitempty"`
	// 选配信息
	SelectedOptions string `protobuf:"bytes,19,opt,name=selectedOptions,proto3" json:"selectedOptions,omitempty"`
	// 特性简述
	PropertyBrief string `protobuf:"bytes,20,opt,name=propertyBrief,proto3" json:"propertyBrief,omitempty"`
	// 标准节拍
	StandardWorkTime int32 `protobuf:"varint,21,opt,name=standardWorkTime,proto3" json:"standardWorkTime,omitempty"`
	// 已发料数量
	IssuedQTY int32 `protobuf:"varint,22,opt,name=issuedQTY,proto3" json:"issuedQTY,omitempty"`
	// 最新发料时间
	LastIssueTime string `protobuf:"bytes,23,opt,name=lastIssueTime,proto3" json:"lastIssueTime,omitempty"`
	// 预计开工时间
	EstimateStartTime string `protobuf:"bytes,24,opt,name=estimateStartTime,proto3" json:"estimateStartTime,omitempty"`
	// 实际开工时间
	ActualStartTime string `protobuf:"bytes,25,opt,name=actualStartTime,proto3" json:"actualStartTime,omitempty"`
	// 已开工数量
	StartedQTY int32 `protobuf:"varint,26,opt,name=startedQTY,proto3" json:"startedQTY,omitempty"`
	// 已淘汰数量
	ObsoletedQTY int32 `protobuf:"varint,27,opt,name=obsoletedQTY,proto3" json:"obsoletedQTY,omitempty"`
	// 已完工数量
	FinishedQTY int32 `protobuf:"varint,28,opt,name=finishedQTY,proto3" json:"finishedQTY,omitempty"`
	// 预计单件耗时
	EstimateConsumeTimePerPiece int32 `protobuf:"varint,29,opt,name=estimateConsumeTimePerPiece,proto3" json:"estimateConsumeTimePerPiece,omitempty"`
	// 预计完工时间
	EstimateFinishTime string `protobuf:"bytes,30,opt,name=estimateFinishTime,proto3" json:"estimateFinishTime,omitempty"`
	// 实际完工时间
	ActualFinishTime string `protobuf:"bytes,31,opt,name=actualFinishTime,proto3" json:"actualFinishTime,omitempty"`
	// 平均单件耗时
	AverageConsumeTimePerPiece int32 `protobuf:"varint,32,opt,name=averageConsumeTimePerPiece,proto3" json:"averageConsumeTimePerPiece,omitempty"`
	// 已入库数量
	DepositedQTY int32 `protobuf:"varint,33,opt,name=depositedQTY,proto3" json:"depositedQTY,omitempty"`
	// 最新入库时间
	LastDepositTime string `protobuf:"bytes,34,opt,name=lastDepositTime,proto3" json:"lastDepositTime,omitempty"`
	// 当前状态
	CurrentState string `protobuf:"bytes,35,opt,name=currentState,proto3" json:"currentState,omitempty"`
	// 最新更新时间
	LastUpdateTime string `protobuf:"bytes,36,opt,name=lastUpdateTime,proto3" json:"lastUpdateTime,omitempty"`
	// 备注
	Remark string `protobuf:"bytes,37,opt,name=remark,proto3" json:"remark,omitempty"`
	// 产品型号ID
	ProductModelID string            `protobuf:"bytes,38,opt,name=productModelID,proto3" json:"productModelID,omitempty"`
	ProductModel   *ProductModelInfo `protobuf:"bytes,39,opt,name=productModel,proto3" json:"productModel,omitempty"`
	// 发放产线ID
	ProductionLineID string              `protobuf:"bytes,40,opt,name=productionLineID,proto3" json:"productionLineID,omitempty"`
	ProductionLine   *ProductionLineInfo `protobuf:"bytes,41,opt,name=productionLine,proto3" json:"productionLine,omitempty"`
	// 工单附件
	ProductOrderAttachments []*ProductOrderAttachmentInfo `protobuf:"bytes,50,rep,name=productOrderAttachments,proto3" json:"productOrderAttachments,omitempty"`
	// 工单BOM
	ProductOrderBoms []*ProductOrderBomInfo `protobuf:"bytes,42,rep,name=productOrderBoms,proto3" json:"productOrderBoms,omitempty"`
	// 产品信息
	ProductInfos []*ProductInfoInfo `protobuf:"bytes,43,rep,name=productInfos,proto3" json:"productInfos,omitempty"`
	// 产品工单属性
	ProductOrderAttributes []*ProductOrderAttributeInfo `protobuf:"bytes,44,rep,name=productOrderAttributes,proto3" json:"productOrderAttributes,omitempty"`
	// 产品工单工序
	ProductOrderProcesses []*ProductOrderProcessInfo `protobuf:"bytes,45,rep,name=productOrderProcesses,proto3" json:"productOrderProcesses,omitempty"`
	// 产品工单标签
	ProductOrderLabels []*ProductOrderLabelInfo `protobuf:"bytes,49,rep,name=productOrderLabels,proto3" json:"productOrderLabels,omitempty"`
	// 产品工单包装
	ProductOrderPackages []*ProductOrderPackageInfo `protobuf:"bytes,46,rep,name=productOrderPackages,proto3" json:"productOrderPackages,omitempty"`
	// 产品工单栈板
	ProductOrderPallets []*ProductOrderPalletInfo `protobuf:"bytes,48,rep,name=productOrderPallets,proto3" json:"productOrderPallets,omitempty"`
}
...
type QueryProductOrderRequest struct {
	...
	SalesOrderNo string `protobuf:"bytes,7,opt,name=salesOrderNo,proto3" json:"salesOrderNo,omitempty"`
	// 销售项号
	// @inject_tag: uri:"itemNo" form:"itemNo"
	ItemNo string `protobuf:"bytes,8,opt,name=itemNo,proto3" json:"itemNo,omitempty"`
	// 创建时间开始
	// @inject_tag: uri:"createTime0" form:"createTime0"
	CreateTime0 string `protobuf:"bytes,18,opt,name=createTime0,proto3" json:"createTime0,omitempty"`
	// 创建时间结束
	// @inject_tag: uri:"createTime1" form:"createTime1"
	CreateTime1 string `protobuf:"bytes,19,opt,name=createTime1,proto3" json:"createTime1,omitempty"`
}
...
type QueryProductOrderResponse struct {
	...
	Data    []*ProductOrderInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
...
type GetProductOrderDetailResponse struct {
	...
	Code    Code              `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string            `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProductOrderInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type GetProductInfoRequest struct {
	...
	ProductSerialNo string `protobuf:"bytes,1,opt,name=productSerialNo,proto3" json:"productSerialNo,omitempty"`
}
...
type ProductInfoInfo struct {
	...
	// 产品序列号
	ProductSerialNo string `protobuf:"bytes,3,opt,name=productSerialNo,proto3" json:"productSerialNo,omitempty"`
	// 防伪码
	SecurityCode string `protobuf:"bytes,4,opt,name=securityCode,proto3" json:"securityCode,omitempty"`
	// 防伪链接
	SecurityUrl string `protobuf:"bytes,5,opt,name=securityUrl,proto3" json:"securityUrl,omitempty"`
	// 创建时间
	CreateTime string `protobuf:"bytes,6,opt,name=createTime,proto3" json:"createTime,omitempty"`
	// 创建人员ID
	CreateUserID   string `protobuf:"bytes,7,opt,name=createUserID,proto3" json:"createUserID,omitempty"`
	CreateUserName string `protobuf:"bytes,21,opt,name=createUserName,proto3" json:"createUserName,omitempty"`
	// 发放时间
	ReleaseTime string `protobuf:"bytes,8,opt,name=releaseTime,proto3" json:"releaseTime,omitempty"`
	// 发料时间
	IssuedTime string `protobuf:"bytes,9,opt,name=issuedTime,proto3" json:"issuedTime,omitempty"`
	// 上线时间
	StartedTime string `protobuf:"bytes,10,opt,name=startedTime,proto3" json:"startedTime,omitempty"`
	// 剩余工序
	RemainingRoutes int32 `protobuf:"varint,11,opt,name=remainingRoutes,proto3" json:"remainingRoutes,omitempty"`
	// 预计下线时间
	EstimateTime string `protobuf:"bytes,12,opt,name=estimateTime,proto3" json:"estimateTime,omitempty"`
	// 下线时间
	FinishedTime string `protobuf:"bytes,13,opt,name=finishedTime,proto3" json:"finishedTime,omitempty"`
	// 入库时间
	DepositedTime string `protobuf:"bytes,14,opt,name=depositedTime,proto3" json:"depositedTime,omitempty"`
	// 当前状态
	CurrentState string `protobuf:"bytes,15,opt,name=currentState,proto3" json:"currentState,omitempty"`
	// 更新时间
	LastUpdateTime string `protobuf:"bytes,16,opt,name=lastUpdateTime,proto3" json:"lastUpdateTime,omitempty"`
	// 备注
	Remark string `protobuf:"bytes,17,opt,name=remark,proto3" json:"remark,omitempty"`
	// 产品工单ID
	ProductOrderID string            `protobuf:"bytes,18,opt,name=productOrderID,proto3" json:"productOrderID,omitempty"`
	ProductOrder   *ProductOrderInfo `protobuf:"bytes,20,opt,name=productOrder,proto3" json:"productOrder,omitempty"`
	// 当前工序ID
	ProductionProcessID string `protobuf:"bytes,19,opt,name=productionProcessID,proto3" json:"productionProcessID,omitempty"`
}
...
type QueryProductInfoRequest struct {
	...
	ProductSerialNo string `protobuf:"bytes,5,opt,name=productSerialNo,proto3" json:"productSerialNo,omitempty"`
	// 创建时间开始
	// @inject_tag: uri:"createTime0" form:"createTime0"
	CreateTime0 string `protobuf:"bytes,8,opt,name=createTime0,proto3" json:"createTime0,omitempty"`
	// 创建时间结束
	// @inject_tag: uri:"createTime1" form:"createTime1"
	CreateTime1 string `protobuf:"bytes,9,opt,name=createTime1,proto3" json:"createTime1,omitempty"`
	// 生产工单号
	// @inject_tag: uri:"productOrderNo" form:"productOrderNo"
	ProductOrderNo string `protobuf:"bytes,10,opt,name=productOrderNo,proto3" json:"productOrderNo,omitempty"`
	// 当前状态
	// @inject_tag: uri:"currentState" form:"currentState"
	CurrentState string `protobuf:"bytes,17,opt,name=currentState,proto3" json:"currentState,omitempty"`
}
...
type QueryProductInfoResponse struct {
	...
	Code    Code               `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string             `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    []*ProductInfoInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	Pages   int64              `protobuf:"varint,4,opt,name=pages,proto3" json:"pages,omitempty"`
	Records int64              `protobuf:"varint,5,opt,name=records,proto3" json:"records,omitempty"`
	Total   int64              `protobuf:"varint,6,opt,name=total,proto3" json:"total,omitempty"`
}
...
type GetProductInfoDetailResponse struct {
	...
	Code    Code             `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string           `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProductInfoInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type ProductOrderAttributeInfo struct {
	...
	// 产品特性ID
	ProductAttributeID string `protobuf:"bytes,4,opt,name=productAttributeID,proto3" json:"productAttributeID,omitempty"`
	// 产品特性
	ProductAttribute *ProductAttributeInfo `protobuf:"bytes,5,opt,name=productAttribute,proto3" json:"productAttribute,omitempty"`
	// 创建时间
	CreateTime string `protobuf:"bytes,6,opt,name=createTime,proto3" json:"createTime,omitempty"`
	// 创建人员ID
	CreateUserID   string `protobuf:"bytes,7,opt,name=createUserID,proto3" json:"createUserID,omitempty"`
	...
	// 隶属工单ID
	ProductOrderID string `protobuf:"bytes,8,opt,name=productOrderID,proto3" json:"productOrderID,omitempty"`
	// 隶属工单
	ProductOrder *ProductOrderInfo `protobuf:"bytes,9,opt,name=productOrder,proto3" json:"productOrder,omitempty"`
}
...
type QueryProductOrderAttributeResponse struct {
	...
	Code    Code                         `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                       `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    []*ProductOrderAttributeInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	Pages   int64                        `protobuf:"varint,4,opt,name=pages,proto3" json:"pages,omitempty"`
	Records int64                        `protobuf:"varint,5,opt,name=records,proto3" json:"records,omitempty"`
	Total   int64                        `protobuf:"varint,6,opt,name=total,proto3" json:"total,omitempty"`
}
...
type GetProductOrderAttributeDetailResponse struct {
	...
	Code    Code                       `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                     `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProductOrderAttributeInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type ProductOrderPalletInfo struct {
	...
	Id string `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	// 栈板编号
	PalletNo string `protobuf:"bytes,3,opt,name=palletNo,proto3" json:"palletNo,omitempty"`
	// 栈板序号
	PalletSn string `protobuf:"bytes,4,opt,name=palletSn,proto3" json:"palletSn,omitempty"`
	// 创建时间
	CreateTime string `protobuf:"bytes,5,opt,name=createTime,proto3" json:"createTime,omitempty"`
	// 码垛箱数
	PackageQuantity int32 `protobuf:"varint,6,opt,name=packageQuantity,proto3" json:"packageQuantity,omitempty"`
	// 当前状态
	CurrentState string `protobuf:"bytes,7,opt,name=currentState,proto3" json:"currentState,omitempty"`
	// 状态变更时间
	LastUpdateTime string `protobuf:"bytes,8,opt,name=lastUpdateTime,proto3" json:"lastUpdateTime,omitempty"`
	// 备注
	Remark string `protobuf:"bytes,9,opt,name=remark,proto3" json:"remark,omitempty"`
	// 码垛规则ID
	ProductPackageStackRuleID string                       `protobuf:"bytes,10,opt,name=productPackageStackRuleID,proto3" json:"productPackageStackRuleID,omitempty"`
	ProductPackageStackRule   *ProductPackageStackRuleInfo `protobuf:"bytes,11,opt,name=productPackageStackRule,proto3" json:"productPackageStackRule,omitempty"`
	// 归属工单ID
	ProductOrderID string            `protobuf:"bytes,12,opt,name=productOrderID,proto3" json:"productOrderID,omitempty"`
	ProductOrder   *ProductOrderInfo `protobuf:"bytes,13,opt,name=productOrder,proto3" json:"productOrder,omitempty"`
}
...
type QueryProductOrderPalletRequest struct {
	...
	PalletNo string `protobuf:"bytes,5,opt,name=palletNo,proto3" json:"palletNo,omitempty"`
	// 栈板序号
	// @inject_tag: uri:"palletSn" form:"palletSn"
	PalletSn string `protobuf:"bytes,6,opt,name=palletSn,proto3" json:"palletSn,omitempty"`
	// 创建时间开始
	// @inject_tag: uri:"createTime0" form:"createTime0"
	CreateTime0 string `protobuf:"bytes,7,opt,name=createTime0,proto3" json:"createTime0,omitempty"`
	// 创建时间结束
	// @inject_tag: uri:"createTime1" form:"createTime1"
	CreateTime1 string `protobuf:"bytes,8,opt,name=createTime1,proto3" json:"createTime1,omitempty"`
	// 当前状态
	// @inject_tag: uri:"currentState" form:"currentState"
...
type QueryProductOrderPalletResponse struct {
	...
	Code    Code                      `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                    `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    []*ProductOrderPalletInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	Pages   int64                     `protobuf:"varint,4,opt,name=pages,proto3" json:"pages,omitempty"`
	Records int64                     `protobuf:"varint,5,opt,name=records,proto3" json:"records,omitempty"`
	Total   int64                     `protobuf:"varint,6,opt,name=total,proto3" json:"total,omitempty"`
}
...
type GetProductOrderPalletDetailResponse struct {
	...
	Code    Code                    `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                  `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProductOrderPalletInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type ProductOrderLabelInfo struct {
	...
	ProductOrder   *ProductOrderInfo `protobuf:"bytes,3,opt,name=productOrder,proto3" json:"productOrder,omitempty"`
	// 标签类型ID
	LabelTypeID string         `protobuf:"bytes,4,opt,name=labelTypeID,proto3" json:"labelTypeID,omitempty"`
	LabelType   *LabelTypeInfo `protobuf:"bytes,5,opt,name=labelType,proto3" json:"labelType,omitempty"`
	// 模板文件
	FilePath string `protobuf:"bytes,6,opt,name=filePath,proto3" json:"filePath,omitempty"`
	// 引用次数
	ReferTimes int32 `protobuf:"varint,7,opt,name=referTimes,proto3" json:"referTimes,omitempty"`
	// 需要复核
	DoubleCheck bool `protobuf:"varint,8,opt,name=doubleCheck,proto3" json:"doubleCheck,omitempty"`
	// 创建时间
	...
	CreateUserName string `protobuf:"bytes,16,opt,name=createUserName,proto3" json:"createUserName,omitempty"`
	// 复核时间
	CheckTime string `protobuf:"bytes,11,opt,name=checkTime,proto3" json:"checkTime,omitempty"`
	// 复核人员ID
	CheckUserID   string `protobuf:"bytes,12,opt,name=checkUserID,proto3" json:"checkUserID,omitempty"`
	CheckUserName string `protobuf:"bytes,17,opt,name=checkUserName,proto3" json:"checkUserName,omitempty"`
	// 当前状态
	CurrentState string `protobuf:"bytes,13,opt,name=currentState,proto3" json:"currentState,omitempty"`
	// 状态变更时间
	LastUpdateTime string `protobuf:"bytes,14,opt,name=lastUpdateTime,proto3" json:"lastUpdateTime,omitempty"`
	// 标签参数
	ProductOrderLabelParameters []*ProductOrderLabelParameterInfo `protobuf:"bytes,15,rep,name=productOrderLabelParameters,proto3" json:"productOrderLabelParameters,omitempty"`
}
...
type ProductOrderLabelParameterInfo struct {
	...
	Id                  string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	ProductOrderLabelID string `protobuf:"bytes,2,opt,name=productOrderLabelID,proto3" json:"productOrderLabelID,omitempty"`
	Name                string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	FixedValue          string `protobuf:"bytes,4,opt,name=fixedValue,proto3" json:"fixedValue,omitempty"`
...
type QueryProductOrderLabelRequest struct {
	...
	// 创建时间开始
	// @inject_tag: uri:"createTime0" form:"createTime0"
	CreateTime0 string `protobuf:"bytes,6,opt,name=createTime0,proto3" json:"createTime0,omitempty"`
	// 创建时间结束
	// @inject_tag: uri:"createTime1" form:"createTime1"
	CreateTime1 string `protobuf:"bytes,7,opt,name=createTime1,proto3" json:"createTime1,omitempty"`
}
...
type QueryProductOrderLabelResponse struct {
	...
	Code    Code                     `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                   `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    []*ProductOrderLabelInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	Pages   int64                    `protobuf:"varint,4,opt,name=pages,proto3" json:"pages,omitempty"`
	Records int64                    `protobuf:"varint,5,opt,name=records,proto3" json:"records,omitempty"`
	Total   int64                    `protobuf:"varint,6,opt,name=total,proto3" json:"total,omitempty"`
}
...
type GetProductOrderLabelDetailResponse struct {
	...
	Code    Code                   `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProductOrderLabelInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type ProductOrderAttachmentInfo struct {
	...
	// 文件大小
	FileSize float32 `protobuf:"fixed32,5,opt,name=fileSize,proto3" json:"fileSize,omitempty"`
	// 保存文件名
	SavedFileName string `protobuf:"bytes,6,opt,name=savedFileName,proto3" json:"savedFileName,omitempty"`
	// 文件状态
	FileStatus string `protobuf:"bytes,7,opt,name=fileStatus,proto3" json:"fileStatus,omitempty"`
	// 创建时间
	...
	// 隶属工单ID
	ProductOrderID string            `protobuf:"bytes,10,opt,name=productOrderID,proto3" json:"productOrderID,omitempty"`
	ProductOrder   *ProductOrderInfo `protobuf:"bytes,12,opt,name=productOrder,proto3" json:"productOrder,omitempty"`
}
...
type QueryProductOrderAttachmentResponse struct {
	...
	Code    Code                          `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                        `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    []*ProductOrderAttachmentInfo `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	Pages   int64                         `protobuf:"varint,4,opt,name=pages,proto3" json:"pages,omitempty"`
	Records int64                         `protobuf:"varint,5,opt,name=records,proto3" json:"records,omitempty"`
	Total   int64                         `protobuf:"varint,6,opt,name=total,proto3" json:"total,omitempty"`
}
...
type GetProductOrderAttachmentDetailResponse struct {
	...
	Code    Code                        `protobuf:"varint,1,opt,name=code,proto3,enum=proto.Code" json:"code,omitempty"`
	Message string                      `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Data    *ProductOrderAttachmentInfo `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
